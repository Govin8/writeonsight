...
export default function App() {
  ...
  const [userProfile, setUserProfile] = useState({
    name: "",
    email: "",
    avatar: "https://via.placeholder.com/150", // Default placeholder avatar
  });
  ...
  const handleSaveChanges = () => {
    ...
    // In a real app, this would send the updated profile (including avatar) to a backend
  };
              ...
              >
                ...
                >
                  ...
                  <div 
                    style={{
                      marginTop: '1rem',
                      width: '100%', // Ensure the container matches other inputs
                      display: 'flex',
                  ...
                  >
                    <input
                      ...
                      style={{
                        padding: '1rem 1.2rem', // Match padding of other inputs
                        border: '2px solid #d1d5db',
                        borderRadius: '12px',
                        fontSize: '1.1rem', // Match font size of other inputs
                        fontWeight: '400',
                        color: '#1e293b',
